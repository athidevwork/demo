...
<%--
  ...
  04/08/2009       kshen       Added actionItemGroupIdCssWidthInPX property
                               to change the width of buttons.
  ...
  10/22/2018       dzhang      Issue 195835: grid replacement - Add CIORGSPECIALHANDLINGB field to fix the italic style is not set when SP handling grid has data.
  ---------------------------------------------------
...
<%
    WebLayer taxLayerFieldsMap = fieldsMap.getLayerFieldsMap("Entity_Organization_Tax_History_Grid_Header_Layer");
    boolean taxLayerHidden = taxLayerFieldsMap.isHidden();
    taxLayerFieldsMap = fieldsMap.getLayerFieldsMap("Entity_Organization_Loss_History_Grid_Header_Layer");
    boolean lossLayerHidden = taxLayerFieldsMap.isHidden();
    taxLayerFieldsMap = fieldsMap.getLayerFieldsMap("Entity_Organization_Dba_History_Grid_Header_Layer");
...
<FORM action="ciEntityOrgModify.do" method="POST">
    ...
    <input type="hidden" name="CIORGSPECIALHANDLINGB">
...
<tr>
    ...
    <td colspan="6">
        <jsp:include page="/core/compiledFormFields.jsp">
            ...
            <jsp:param name="actionItemGroupId" value="CI_ENT_ORG_MOD_AIG"/>
        </jsp:include>
    </td>
</tr>
<tr>
    <td colspan="6">
        <oweb:panel panelContentId="panelContentForNameHistory"
                    panelTitleId="panelTitleIdForNameHistory" panelTitleLayerId="Entity_Organization_Name_History_Grid_Header_Layer">
            <tr>
                <td colspan="6">
                    <c:set var="gridDisplayFormName" value="CIEntityOrgNameForm" scope="request"/>
                    <c:set var="gridDisplayGridId" value="orgNameGrid" scope="request"/>
                    <c:set var="datasrc" value="#orgNameGrid1" scope="request"/>
...
<tr>
    <td colspan="6">
        <oweb:panel panelContentId="panelContentForTaxHistory"
                    panelTitleId="panelTitleIdForTaxHistory" panelTitleLayerId="Entity_Organization_Tax_History_Grid_Header_Layer">
            <tr>
                <td colspan="6">
                    <c:set var="gridDisplayFormName" value="CIEntityOrgTaxForm" scope="request"/>
                    <c:set var="gridDisplayGridId" value="orgTaxGrid" scope="request"/>
                    <c:set var="datasrc" value="#orgTaxGrid1" scope="request"/>
...
<tr>
    <td colspan="6">
        <oweb:panel panelContentId="panelContentForLossHistory"
                    panelTitleId="panelTitleIdForLossHistory" panelTitleLayerId="Entity_Organization_Loss_History_Grid_Header_Layer">
            <tr>
                <td colspan="6">
                    <c:set var="gridDisplayFormName" value="CIEntityOrgLossList" scope="request"/>
                    <c:set var="gridDisplayGridId" value="orgLossGrid" scope="request"/>
                    <c:set var="datasrc" value="#orgLossGrid1" scope="request"/>
...
<tr>
    <td colspan="6">
        <oweb:panel panelContentId="panelContentForDBANameHistory"
                    panelTitleId="panelTitleIdForDBANameHistory" panelTitleLayerId="Entity_Organization_Dba_History_Grid_Header_Layer">
            <tr>
                <td colspan="6">
                    <c:set var="gridDisplayFormName" value="CIEntityOrgDbaList" scope="request"/>
                    <c:set var="gridDisplayGridId" value="orgDbaGrid" scope="request"/>
                    <c:set var="datasrc" value="#orgDbaGrid1" scope="request"/>
