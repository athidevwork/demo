...
<%@ page import="dti.cs.ziplookupmgr.ZipLookupFields" %>
<%@ page language="java" %>
<%--
  Description:
...
<script language="javascript" src="<%=cisPath%>/entityquickaddmgr/js/entityQuickAddOrg.js?<%=ApplicationContext.getInstance().getBuildNumberParameter()%>"></script>
...
<FORM NAME="entityQuickAddForm" action="entityQuickAddOrg.do" method="POST">
    <tr>
        <td colspan="6">
            <oweb:message/>
        </td>
    ...
    <input type="hidden" name="entity_entityType" value="O"/>
    ...
    <tr>
      <td colspan="6" align="center">
        <oweb:actionGroup actionItemGroupId="CI_QUICKADDORG_AIG" cssColorScheme="blue" layoutDirection="horizontal"/>
      </td>
    </tr>
    ...
    <tr>
        <td align=center>
            <jsp:include page="/core/compiledFormFields.jsp">
                ...
                <jsp:param name="divId" value="quickAddOrgForm"/>
            </jsp:include>
        </td>
    </tr>
    ...
    <tr>
        <td align=center>
            <oweb:panel panelTitleId="panelTitleIdForAddress"
                        ...
                        panelTitleLayerId="CI_QUICK_ORG_ADDRESS">
                <tr>
                    <td align=center>
                        <jsp:include page="/core/compiledFormFields.jsp">
                            ...
                            <jsp:param name="includeLayerIds" value="CI_QUICK_ORG_ADDRESS"/>
                        </jsp:include>
                    </td>
                </tr>
            </oweb:panel>
    ...
    <tr>
        <td align=center>
            <oweb:panel panelTitleId="panelTitleIdForPhone"
                        ...
                        panelTitleLayerId="CI_QUICK_ORG_PHONE">
                <tr>
                    <td align=center>
                        <jsp:include page="/core/compiledFormFields.jsp">
                            ...
                            <jsp:param name="excludePageFields" value="true"/>
                            <jsp:param name="isLayerVisibleByDefault" value="true"/>
                            <jsp:param name="includeLayerIds" value="CI_QUICK_ORG_PHONE"/>
                        </jsp:include>
                    </td>
                </tr>
            </oweb:panel>
    ...
    <tr>
        <td align=center>
            <oweb:panel panelTitleId="panelTitleIdForLicense"
                        ...
                        panelTitleLayerId="CI_QUICK_ORG_LICENSE">
                <tr>
                    <td align=center>
                        <jsp:include page="/core/compiledFormFields.jsp">
                            ...
                            <jsp:param name="excludePageFields" value="true"/>
                            <jsp:param name="isLayerVisibleByDefault" value="true"/>
                            <jsp:param name="includeLayerIds" value="CI_QUICK_ORG_LICENSE"/>
                        </jsp:include>
                    </td>
                </tr>
            </oweb:panel>
    ...
    <tr>
        <td align=center>
            <oweb:panel panelTitleId="panelTitleIdForDenominator"
                        ...
                        panelTitleLayerId="CI_QUICK_ORG_DENOMINATOR">
                <tr>
                    <td align=center>
                        <jsp:include page="/core/compiledFormFields.jsp">
                            ...
                            <jsp:param name="excludePageFields" value="true"/>
                            <jsp:param name="isLayerVisibleByDefault" value="true"/>
                            <jsp:param name="includeLayerIds" value="CI_QUICK_ORG_DENOMINATOR"/>
                        </jsp:include>
                    </td>
                </tr>
            </oweb:panel>
    ...
    <tr>
        <td align=center>
            <oweb:panel panelTitleId="panelTitleIdForPriorCarrier"
                        ...
                        panelTitleLayerId="CI_QUICK_ORG_PRIORCARRIER">
                <tr>
                    <td align=center>
                        <jsp:include page="/core/compiledFormFields.jsp">
                            ...
                            <jsp:param name="excludePageFields" value="true"/>
                            <jsp:param name="isLayerVisibleByDefault" value="true"/>
                            <jsp:param name="includeLayerIds" value="CI_QUICK_ORG_PRIORCARRIER"/>
                        </jsp:include>
                    </td>
                </tr>
            </oweb:panel>
