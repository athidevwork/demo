...
<form name="changeAddressRoleForm" action="ciChgAddressRole.do" method="post">
    ...
    <tr>
        <td colspan=6>
            <fmt:message key="ci.address.addressRoleChange.informationPanelTitle" var="informationPanelTitle" scope="request"/>
            <% String informationPanelTitle = (String) request.getAttribute("informationPanelTitle"); %>
            <jsp:include page="/core/compiledFormFields.jsp">
                <jsp:param name="divId" value="informationDiv"/>
                <jsp:param name="isGridBased" value="false"/>
                <jsp:param name="excludeAllLayers" value="true"/>
                <jsp:param name="headerText" value="<%=informationPanelTitle%>"/>
            </jsp:include>
        </td>
    </tr>
    <tr>
            ...
            <oweb:panel panelTitleId="panelTitleForAddressRoleList" panelContentId="panelContentIdForAddressRoleList" panelTitleLayerId="CI_CHG_ADR_ROLE_LIST_GH">
                <tr>
                    <td colspan="6" align=center>
                        ...
                        <c:set var="selectable" value="true" scope="request"/>
    ...
    <tr>
        <td colspan=6 align=center>
            <oweb:actionGroup actionItemGroupId="CI_CHG_ADR_ROLE_AIG" layoutDirection="horizontal" cssColorScheme="blue"/>
        </td>
    </tr>
