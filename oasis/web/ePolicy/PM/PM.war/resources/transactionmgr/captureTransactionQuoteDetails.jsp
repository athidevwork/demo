...
<script language="javascript" src="<%=appPath%>/transactionmgr/js/captureTransactionQuoteDetails.js?<%=ApplicationContext.getInstance().getBuildNumberParameter()%>"></script>

<jsp:useBean id="fieldsMap" class="dti.oasis.tags.OasisFields" scope="request"/>

<FORM action="captureTransactionQuoteDetails.do" method="POST" NAME ="captureTransactionQuoteDetailsFORM">
