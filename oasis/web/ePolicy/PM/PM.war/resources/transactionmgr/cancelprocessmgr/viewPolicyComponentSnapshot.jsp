...
<jsp:useBean id="policyComponentSnapshotGridDataBean" class="dti.oasis.util.BaseResultSet" scope="request"/>
<jsp:useBean id="gridHeaderBean" class="dti.oasis.tags.XMLGridHeader" scope="request"/>
<jsp:useBean id="fieldsMap" class="dti.oasis.tags.OasisFields" scope="request"/>
<tr>
    <td>
        <c:set var="gridDisplayFormName" value="policyComponentSnapshotForm" scope="request"/>
        <c:set var="gridDisplayGridId" value="policyComponentSnapshotGrid" scope="request"/>
        <c:set var="gridSizeFieldIdPrefix" value="polComp_" scope="request"/>
        <% BaseResultSet dataBean = policyComponentSnapshotGridDataBean; %>
