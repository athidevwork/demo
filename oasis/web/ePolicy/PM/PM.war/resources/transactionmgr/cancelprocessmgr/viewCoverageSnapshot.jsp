...
<jsp:useBean id="coverageSnapshotGridDataBean" class="dti.oasis.util.BaseResultSet" scope="request"/>
<jsp:useBean id="gridHeaderBean" class="dti.oasis.tags.XMLGridHeader" scope="request"/>
<jsp:useBean id="fieldsMap" class="dti.oasis.tags.OasisFields" scope="request"/>

<tr>
    <td colspan="6">
        <oweb:actionGroup actionItemGroupId="PM_COVG_SNAPSHOT_AIG" layoutDirection="horizontal"
                          cssColorScheme="gray"/>
    </td>
</tr>
<tr>
    <td>
        <c:set var="gridDisplayFormName" value="coverageSnapshotForm" scope="request"/>
        <c:set var="gridDisplayGridId" value="coverageSnapshotGrid" scope="request"/>
        <% BaseResultSet dataBean = coverageSnapshotGridDataBean; %>
