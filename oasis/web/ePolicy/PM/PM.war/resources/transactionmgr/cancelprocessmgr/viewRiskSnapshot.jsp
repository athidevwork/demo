...
<jsp:useBean id="riskSnapshotGridDataBean" class="dti.oasis.util.BaseResultSet" scope="request"/>
<jsp:useBean id="gridHeaderBean" class="dti.oasis.tags.XMLGridHeader" scope="request"/>
<jsp:useBean id="fieldsMap" class="dti.oasis.tags.OasisFields" scope="request"/>

<tr>
    <td colspan="6">
        <oweb:actionGroup actionItemGroupId="PM_RISK_SNAPSHOT_AIG" layoutDirection="horizontal"
                          cssColorScheme="gray"/>
    </td>
</tr>
<tr>
    <td>
        <c:set var="gridDisplayFormName" value="riskSnapshotForm" scope="request"/>
        <c:set var="gridDisplayGridId" value="riskSnapshotGrid" scope="request"/>
        <% BaseResultSet dataBean = riskSnapshotGridDataBean; %>
