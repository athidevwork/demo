...
<script type="text/javascript" src="js/maintainDividendRule.js?<%=ApplicationContext.getInstance().getBuildNumberParameter()%>"></script>

<form name="dividendList" action="maintainDividendRule.do" method=post>
            ...
            <oweb:panel panelTitleId="panelTitleIdForDividendSearchHeader"
                ...
                <tr>
                    ...
                    <td align=left width="70%">
                        <oweb:actionGroup actionItemGroupId="PM_DIV_DEC_SEL_AIG" layoutDirection="horizontal"/>
                    </td>
                </tr>
            </oweb:panel>
        </td>
    ...
    <tr>
        <td align=center>
            ...
            <oweb:panel panelTitleId="panelTitleIdForDividendListHeader"
                ...
                <tr>
                    <td colspan="6">
                        <oweb:actionGroup actionItemGroupId="PM_DIV_DEC_GRID_AIG" layoutDirection="horizontal"
                                cssColorScheme="gray"/>
                    </td>
                </tr>
                <tr>
                ...
                <tr>
                    <td align=center>
                        <jsp:include page="/core/compiledFormFields.jsp">
                            ...
                            <jsp:param name="includeLayersWithPrefix" value="PM_DIVIDEND_DEC_GH"/>
                        </jsp:include>
                    </td>
                </tr>
            </oweb:panel>
    ...
    <tr>
        <td colspan="6" align=center>
            <oweb:actionGroup actionItemGroupId="PM_DIVIDEND_DEC_AIG"/>
        </td>
    </tr>
