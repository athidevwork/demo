...
/**
 * Row style load processor for coverage class
 ...
 * ---------------------------------------------------
 */
public class CoverageClassRowStyleRecordLoadprocessor extends DefaultRecordLoadProcessor {
    /**
    ...
    public boolean postProcessRecord(Record record, boolean rowIsOnCurrentPage) {
        ...
        String rowStyleFieldName = "coverageClassListGridRowStyle";

        if (CoverageClassFields.getCoverageClassStatus(record).isCancelled()) {
    ...
    public void postProcessRecordSet(RecordSet recordSet) {
        ...
        if (recordSet.getSize() == 0) {
            ...
            rowStyleFields.add("coverageClassListGridRowStyle");
    ...
    public static void setInitialEntitlementValuesForRowStyle(Record inputRecord) {
        ...
        CoverageClassRowStyleRecordLoadprocessor lp = new CoverageClassRowStyleRecordLoadprocessor();
