 ...
 * ---------------------------------------------------
 * 06/21/2013       adeng       117011 - Modified getInitialValues() to add field "newTransactionComment2" to ajaxRecord.
 * ---------------------------------------------------
 */
public class CaptureTransactionDetailsAction extends PMBaseAction {
    ...
    public ActionForward getInitialValues(ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response) throws Exception {
        ...
        try {
            ...
            ajaxRecord.setFieldValue("newTransactionComment2",""); // transactionComment2 is entered by user's input, not set by ajax
