 ...
 * ---------------------------------------------------
 */
public class ViewCopyQuoteValidationErrorAction extends PMBaseAction {
    /**
    ...
    public ActionForward loadAllValidationError(ActionMapping mapping, ActionForm form, HttpServletRequest request,
        ...
        try {
            ...
            String remapTransctionId = request.getParameter("remapTransctionId");
            if (remapTransctionId!=null) {
                inputRecord.setFieldValue("transactionLogId", remapTransctionId);
            }

            String remapPolicyNo = request.getParameter("remapPolicyNo");
            if (remapPolicyNo!=null) {
                inputRecord.setFieldValue("remapPolicyNo", remapPolicyNo);
                request.setAttribute("remapPolicyNo", remapPolicyNo);
            }
    ...
    public ViewCopyQuoteValidationErrorAction() {
    }
