<%--
    ...
    09/30/2009       Kenney      Added getAppPath(), it is used in footerpopup.jsp
    ...
    03/22/2011       Kenney      Issue#118737: Include divPopup.js to fix Javascript error
    ...
    12/12/2017       kshen       Grid replacement: adding jquery libs since divpopup depends on jQuery.
    ---------------------------------------------------
...
<%
    ...
    Logger l = LogUtils.getLogger("ErrorPagePopup.jsp");
    ...
    if (l.isLoggable(logLevel)) {
        l.logp(logLevel, "", "", "*** ErrorPagePopup.jsp: " + verboseMsg + " URI:" +  request.getRequestURI());
    }
...
<% pageBean.setLeftNavActions(new ArrayList()); %>
   ...
   <c:when test="${UIStyleEdition=='0'|| UIStyleEdition=='1'}">
      ...
      <tr height="75">
          <td width="180" valign="top" align="left"><div style="position:relative">
              ...
              <img style="position:absolute; top:0px; left:0px;z-index:0;overflow:hidden;"
            ...
            <script type='text/javascript'>
                ...
                function home() {
                    ...
                    if (isDefined(self.opener)) {
                        self.opener.replaceWindowLocation(appContext);
                        window.close();
                    }
                    else if (isDefined(window.frameElement)) {
                        window.frameElement.document.parentWindow.replaceWindowLocation(appContext);
                    }
                    else
                ...
                function logoff() {
                    ...
                    //alert("logoutPage: " + logoutPage);
                    if (isDefined(self.opener)) {
                        self.opener.replaceWindowLocation(logoutPage);
                        window.close();
                    }
                    else if (isDefined(window.frameElement)) {
                        window.frameElement.document.parentWindow.replaceWindowLocation(logoutPage);
                    }
                    else
                ...
                <tr><td>&nbsp;</td></tr>
                <tr><td>
                    <input type=button class="buttonText" value="Close" onClick="javascript:closeWindow();">
