/**
 * @license jQWidgets v4.5.0 (2017-Jan)
        ...
        setcellvalue: function (row, datafield, value, refresh, sync) {
            ...
            if (refresh == true || refresh == undefined) {
                ...
                if (hasfilter && !hasgroups) {
                    ...
                    this.dataview.refresh(null, {skipFilters: true});
                    this.rendergridcontent(true, false);
                    updatepager();
                    this._renderrows(this.virtualsizeinfo);
                }
    ...
    $.jqx.dataview = function () {
        ...
        this.addrow = function (rowid, rowdata, position, refresh) {
            if (rowdata != undefined) {
                ...
                this.addSkipFilterRowId(this.source.id ? rowdata[this.source.id] : rowdata.uid);
                ...
                if (refresh == true || refresh == undefined) {
                    this.refresh(null, {skipFilters: true});
                }
                ...
                if (this.recordsbyid["id" + rowid] && !hasFilter) {
                    ...
                    if (record) {
                        ...
                        if (refresh == true || refresh == undefined) {
                            ...
                            this.removeSkipFilterRowId(rowid);
                            this.refresh(null, {skipFilters: true});
                        }
                        return true;
                    }
        ...
        this.skipFilterOnThisRow = function (rowId) {
            this.skipFilterRowIds = this.skipFilterRowIds || {};

            return this.skipFilterRowIds.hasOwnProperty(rowId);
        };

        this.addSkipFilterRowId = function (rowId) {
            this.skipFilterRowIds = this.skipFilterRowIds || {};
            this.skipFilterRowIds[rowId] = rowId;
        };

        this.removeSkipFilterRowId = function (rowId) {
            if (this.skipFilterRowIds && this.skipFilterRowIds.hasOwnProperty(rowId)) {
                delete this.skipFilterRowIds[rowId];
            }
        };

        this.refresh = function (fullupdate, options) {
            ...
            if (this.filters.length > 0 && !this.virtualmode) {
                ...
                if (this.source != null && this.source.filter != undefined && this.source.localdata != undefined) {
                    ...
                    if (!options.skipFilters) {
                        this.skipFilterRowIds = {};
                    }

                    for (var row = 0; row < length; row++) {
                        var datarow = data[row];
                        var filterresult = undefined;
                        var rowId = this.source.id ? datarow[this.source.id] : datarow.uid;

                        if (options.skipFilters) {
                            filterresult = this.skipFilterOnThisRow(rowId);
                        } else {
                            for (var j = 0; j < filterslength; j++) {
                                var filter = this.filters[j].filter;
                                if (filter && filter.evaluate && typeof filter.evaluate == "function") {
