...
(function ($) {
    ...
    $.extend($.jqx._jqxGrid.prototype, {
        ...
        endcelledit: function (row, datafield, cancelchanges, refresh, focus) {
            ...
            // Raise postCellEndEdit event.
            this._raiseEvent(26, { rowindex: row, row: datarow, datafield: datafield, displayfield: column.displayfield, oldvalue: oldvalue, value: editorvalue, columntype: column.columntype });
                    ...
                    if (this.host.jqxDropDownList) {
                        ...
                        if (dropdownlisteditor == undefined) {
                            ...
                            if (!isdataadapter) {
                                ...
                                // Fix the bug that record id changed when editing a dropdown list cell.
                                var dataSource =
                                {
                                    id: this.source._source.id,
                    ...
                    if (this.host.jqxComboBox) {
                        ...
                        if (comboboxeditor == undefined) {
                            ...
                            if (!isdataadapter) {
                                ...
                                // Fix the bug that record id changed when editing a combobox cell.
                                var dataSource =
                                {
                                    id: this.source._source.id,
                                    localdata: this.source.records,
