...
<%
    ...
    Logger l = LogUtils.getLogger("ErrorIFrame.jsp");
    ...
    if (l.isLoggable(logLevel)) {
        l.logp(logLevel, "", "", "*** ErrorIFrame.jsp: " + verboseMsg + " URI:" + request.getRequestURI());
    }
    ...
    if (e != null &&
        (e instanceof IllegalAccessException ||
            (e instanceof AppException && ((AppException) e).getCause() instanceof IllegalAccessException))) {
