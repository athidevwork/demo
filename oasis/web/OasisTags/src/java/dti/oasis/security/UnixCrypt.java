...
public class UnixCrypt extends Object {
    ...
    public static final String crypt(String original) {
        ...
        Integer randomA = randomGenerator.nextInt();
        if (Integer.MIN_VALUE == randomA) {
            randomA = Integer.MAX_VALUE;
        }
        saltBuffer.append(saltChars[Math.abs(randomA) % numSaltChars]);
        Integer randomB = randomGenerator.nextInt();
        if (Integer.MIN_VALUE == randomB) {
            randomB = Integer.MAX_VALUE;
        }
        saltBuffer.append(saltChars[Math.abs(randomB) % numSaltChars]);
        return crypt(saltBuffer.toString(), original);
