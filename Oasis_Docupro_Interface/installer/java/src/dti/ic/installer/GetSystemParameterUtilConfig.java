 ...
 * ---------------------------------------------------
 */
public class GetSystemParameterUtilConfig extends CustomCodeAction {
    ...
    protected void executeDisplayConfig(Connection connection, InstallerProxy installerProxy) {
        ...
        try {
                ...
                for (int i = 1; i <= columnsNumber; i++) {
                    ...
                    switch (i) {
                        case 1:
                            ...
                            break;
                        case 2:
                            configData.append(pad(columnValue, 100));
                            break;
                        case 3:
                            configData.append(pad(columnValue, 1000)).append("\n");
                            break;
                    }
                }
                configData.append("");
            ...
            String configLog = logPath + File.separator + "sys_parm_util_config"+ df.format(new java.util.Date()) +".log";
